package com.myapp.sporify.adapters.albums;
 ...
 */
public class ArtistAlbumsAdapter extends RecyclerView.Adapter<ArtistAlbumsAdapter.AlbumHolder> {
    ...
    public AlbumHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.artist_album_item , parent , false);
        return new ArtistAlbumsAdapter.AlbumHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull AlbumHolder holder, int position) {
        ...
        holder.rank.setText(String.valueOf(album.getRank()));
        ...
        holder.albumPlay.setText("Total plays: " + String.format(Locale.US,"%,d", album.getPlayCount()));
        ...
        holder.albumItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(album.getMbid().isEmpty()){
                    Toast.makeText(context, "No info for this album!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public static class AlbumHolder extends RecyclerView.ViewHolder{
        ...
        TextView  rank, name, artistName, albumPlay;
        ImageView image;
        ...
        public AlbumHolder(@NonNull View itemView) {
            ...
            albumPlay = itemView.findViewById(R.id.album_play);
